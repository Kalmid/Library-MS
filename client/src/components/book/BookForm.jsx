...
const BookForm = ({ methods, onFormReset, onFormSubmit }) => {
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2" placeholder="Enter Title"
                        />
                        {errors.title?.type==='required' && <p className="mt-1 text-sm text-red-600 flex items-center">
                            Title is required
                        </p>}                        
                    </div>
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2" placeholder="Enter Author"
                        />
                         {errors.title?.type==='required' && <p className="mt-1 text-sm text-red-600 flex items-center">
                            Author is required
                        </p>} 
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2" placeholder="Enter Description"
                        />
                         {errors.title?.type==='required' && <p className="mt-1 text-sm text-red-600 flex items-center">
